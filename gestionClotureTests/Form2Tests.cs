...
namespace gestionCloture.Tests
{
    [TestClass()]
    public class Form2Tests
    {
        ...
        public void getMoisPrecedentTestMoisHuit()
        {
            ...
            string moisPrecedent = gestionCloture.gestionDate.getMoisPrecedent(date);
        ...
        {
            string moisSuivant = gestionCloture.gestionDate.getMoisSuivant();
        ...
        public void getMoisSuivantTestMoisHuit()
        {
            ...
            string moisSuivant = gestionCloture.gestionDate.getMoisSuivant(date);
        ...
        public void entreTest2et12()
        {
            ...
            Boolean jourEntre = gestionCloture.gestionDate.entre(jour1, jour2, date);
